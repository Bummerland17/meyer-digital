...
HOOK_TEMPLATES = [
    "The {N} mistakes people make with {TOPIC}",
    "{N} things about {TOPIC} nobody tells you",
    "Why {ASSUMPTION} is costing you money 🚫",
    "I wish I knew this sooner: {TIP}",
    "What happens when you {ACTION} — results after {TIMEFRAME}",
    "POV: You finally stop wasting food every week",
    "{N} signs you need a better {TOPIC} system",
    "This is how smart people handle {TOPIC}",
]

NICHE_TOPICS = {
    "pantrymate": [
        "What to make with chicken, rice, and broccoli",
        "5 dinners from ingredients you already have",
        "Stop ordering DoorDash — you have $60 of food at home",
        "Fridge cleanout meals that actually taste good",
        "Dinner decided in 30 seconds — no more staring at the fridge",
        "Meal planning hack that saves $200 a month",
        "What to cook when you think you have nothing",
        "3 ingredients, 10 minute dinner ideas",
        "How to stop wasting food every week",
        "Quick weeknight dinners from pantry staples",
        "The dinner decision that's costing you money",
        "AI tells you what to make from your fridge",
    ],
    "saunamagie": [
